...
const STATUSES = [
  { key: "OPEN", title: "Open", headerBg: "bg-blue-600" },
  { key: "IN_PROGRESS", title: "In Progress", headerBg: "bg-orange-500" },
  { key: "COMPLETED", title: "Completed", headerBg: "bg-green-600" },
  { key: "BLOCKED", title: "Blocked", headerBg: "bg-red-600" },
];
...
function Column({ col, tasks, children }) {
  ...
  return (
    ...
    >
      <div
        className={`rounded-lg ${col.headerBg} text-white px-3 py-2 flex justify-between`}
      >
        <span className="text-sm font-semibold">{col.title}</span>
        <span className="text-xs bg-white/20 px-2 rounded">{tasks.length}</span>
      </div>
    ...
    <div className="px-3 py-4 sm:p-4 bg-gray-50 min-h-screen">
      ...
      <dialog id="task_modal" className="modal">
        ...
        >
          ...
          <form onSubmit={handleSubmit(onCreate)} className="space-y-4 sm:space-y-6">
            {/* BASIC INFO */}
