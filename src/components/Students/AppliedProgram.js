...
//         `https://api.alnawrasplus.com/api/v1/studentComment/${selectedProgram.id}?type=${tab}`
//       );
...
//     try {
//       const res = await axios.get(
//         `https://api.alnawrasplus.com/api/v1/kcComment/${selectedProgram.id}?type=${tab}`
//       );
...
//       await axios.post(
//         "https://api.alnawrasplus.com/api/v1/studentComment/create",
//         formData
//       );
//       setNewComment("");
...
//       await axios.post(
//         "https://api.alnawrasplus.com/api/v1/studentReply/create",
//         formData
//       );
...
//       await axios.post(
//         "https://api.alnawrasplus.com/api/v1/kcComment/create",
//         formData
//       );
//       setNewKCComment("");
...
//       await axios.post("https://api.alnawrasplus.com/api/v1/kcReply/create", formData);
...
//             {comment.file && (
//               <a
//                 href={`https://api.alnawrasplus.com/${comment.file}`}
//                 target="_blank"
...
//                   {reply.file && (
//                     <a
//                       href={`https://api.alnawrasplus.com/${reply.file}`}
//                       target="_blank"
//                       rel="noopener noreferrer"
...
const AppliedProgram = ({ user_id }) => {
  ...
  const handleKCReplySubmit = async (commentId) => {
    ...
    try {
      ...
      await axios.post(
        "https://api.alnawrasplus.com/api/v1/kcReply/create",
        formData,
      );
      setReplyKCContent((prev) => ({ ...prev, [commentId]: "" }));
      setReplyKCFiles((prev) => ({ ...prev, [commentId]: null }));
